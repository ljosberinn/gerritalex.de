    ...
    <>
      ...
      <article>
        <div>
              ...
              <dl>
                ...
                {lastmod ? (
                  <>
                    ...
                    <dd className="flex w-full items-center justify-center gap-1 text-base text-xs leading-6 font-medium text-gray-500 dark:text-gray-400">
                      <svg
                        width="15"
                        height="15"
                        viewBox="0 0 15 15"
          ...
          <div className="grid-rows-[auto_1fr] divide-y divide-gray-200 px-2 pb-8 xl:divide-y-0 dark:divide-gray-700">
