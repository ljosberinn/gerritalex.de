...
I'm an <WowheadSpecIcon spec="devastation-evoker">Devastation Evoker</WowheadSpecIcon>/<WowheadSpecIcon spec="augmentation-evoker">Augmentation Evoker</WowheadSpecIcon> [main](https://www.warcraftlogs.com/character/eu/blackrock/xephyris) playing in [\<Mental Apocalypse\>-Ragnaros](https://www.warcraftlogs.com/guild/id/575362). 
