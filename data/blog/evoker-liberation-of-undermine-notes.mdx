...
- <Zephyr /> most value during intermissions
  - can alternatively be used to mitigated <MoltenPhlegm /> or <Scrapbomb />
...
- spread <Bombardments /> here for extra cdr
...
- precast <WowheadLink id={4338740} icon="ability_evoker_deepbreath">Deep Breath</WowheadLink> on the adds 
