---
title: Retail World of Warcraft - A Passionate Rant
date: '2025-06-03'
tags: ['wow']
summary: 'Game good. Could be better.'
authors: ['default']
...
<WowheadSpecIcon spec="destruction-warlock">Destruction</WowheadSpecIcon> has this <WowheadLink kind="spell" id={387103} icon="spell_fire_fire">Ruin</WowheadLink> talent, increasing critical damage done by **5%** - this is `200% * 1.05` however, so it's 210% effectively. Notably, the spec has no other talent blanket increasing crit damage done, there's only <WowheadLink id={440045} icon="70_inscription_vantus_rune_tomb" kind="spell">Mark of Peroth'arn</WowheadLink> increasing crit damage of <WowheadLink id={445468} kind="spell" icon="inv_ability_hellcallerwarlock_wither">Wither</WowheadLink> specifically.
...
- <WowheadLink kind="item" id={219295} icon="inv_misc_dungeonsignetearthen02_color1">Sigil of Algari Concordance</WowheadLink> (after rightfully getting nerfed)
...
- <WowheadLink id={210271} kind="npc">Brewmaster Aldryr</WowheadLink>, first boss of Cinderbrew Meadery, phases at 66/33% health
