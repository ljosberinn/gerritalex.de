...
The id is directly in the url: `395160`. This only leaves you with having to find a log but chances are, you're not the first one to use use that spell or play the content it's used in so luckily that won't be an issue.
