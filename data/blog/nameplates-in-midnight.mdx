...
- ✔️ addons can allow changing the nameplate color
...
<div className="flex justify-self-center not-prose">
...
You've made it this far, here, have a break cat.
...
<center>
  <figure>
    <img src="/static/images/nameplates-midnight/health-markers.jpg" className="not-prose max-w-[80%]" alt="" loading="lazy" />
    <figcaption>another example, <WowheadLink id={164929} kind="npc">Tirnenn Villagers</WowheadLink> becoming friendly at 20%</figcaption>
  </figure>
</center>
...
After:
- ❌ Midnight Nameplate Options don't indicate these thresholds
- ❌ addons will no longer be able to calculate time to die as the needed data is secret
