...
<div className="flex gap-2 justify-center flex-col xl:flex-row">
  <img src="/static/images/nameplates-midnight/hide-nameplate-retail-off.jpg"  className="not-prose xl:max-w-1/2" alt="significant amount of irrelevant nameplates visible" loading="lazy" />
  <img src="/static/images/nameplates-midnight/hide-nameplate-retail-on.jpg" className="not-prose xl:max-w-1/2"  alt="all irrelevant nameplates are hidden" loading="lazy" />
</div>
