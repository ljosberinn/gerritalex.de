...
##### Verdict & Suggestion
Generally speaking, works. Has a couple problems however:

- if the target unit is on another realm, the realm is not omitted, leading to questionable behaviour
