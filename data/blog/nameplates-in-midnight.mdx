...
##### Verdict
Better than nothing, but needs work. The ability to highlight threat on pets is now gone. It wasn't _extremely_ important, but commonly when such an ability was used it was to help the tank. Now the tank is sweating extra because they think they lost aggro on top of already struggling.
...
<figure className="flex justify-center flex-col">
  <video src="/static/images/nameplates-midnight/aura-name-color.mp4" type="video/mp4" controls muted loop autoPlay />
  <figcaption className="text-center">
...
<div>
  <video className="" src="/static/images/nameplates-midnight/hide-nameplate-midnight.mp4" type="video/mp4" controls muted loop autoPlay />
</div>
