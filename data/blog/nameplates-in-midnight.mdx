...
The target upscaling is a CVar and not exposed as setting.
...
Largely informational, here's some technical bits while we're here. Pruning was imo badly needed. The following nameplate-related CVars are gone:
...
Keeping only these from before:
```
// scaling related
