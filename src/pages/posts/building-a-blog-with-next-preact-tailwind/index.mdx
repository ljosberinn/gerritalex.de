...
export const meta = {
  ...
  image: createOgImageUrl({
    title: 'Building a Blog with Next + Preact + Tailwind',
    fontSize: 80,
  }),
...
so that the site has something to show on the homepage 😅,
...
We all need a playground where we can have a little bit of fun these days. 😄
